    ...
    <div className="space-y-6">
      ...
      <ConfirmDialog
        ...
        onConfirm={async () => {
          ...
          try {
            await regenerateLicenseKey.mutateAsync(pendingRegenerate.id);
            toast.success(
              `License key regenerated for ${pendingRegenerate.name}`,
            );
            notifyPlatform(
              "License key regenerated",
              `The license key for ${pendingRegenerate.name} was regenerated.`,
              "/super-admin/license-manager",
            );
            notifyInstitution(
              pendingRegenerate.id,
      ...
      <ConfirmDialog
        ...
        onConfirm={async () => {
          ...
          try {
            ...
            notifyPlatform(
              "License revoked",
              `${pendingRevoke.name}'s license was revoked and reset to Basic.`,
              "/super-admin/license-manager",
            );
            notifyInstitution(
              pendingRevoke.id,
